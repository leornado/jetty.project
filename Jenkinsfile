          ...
          steps {
            container('jetty-build') {
              timeout( time: 240, unit: 'MINUTES' ) {
                ...
                recordIssues id: "jdk8", name: "Static Analysis jdk8", aggregatingResults: true, enabledForFailure: true, tools: [junitParser(), mavenConsole(), java(), checkStyle(), spotBugs(), pmdParser()]
              }
            }
          }
        }
          ...
          steps {
            container( 'jetty-build' ) {
              timeout( time: 240, unit: 'MINUTES' ) {
                ...
                recordIssues id: "jdk11", name: "Static Analysis jdk11", aggregatingResults: true, enabledForFailure: true, tools: [junitParser(), mavenConsole(), java(), checkStyle(), spotBugs(), pmdParser(), errorProne()]
              }
            }
          }
        }
          ...
          steps {
            container( 'jetty-build' ) {
              timeout( time: 240, unit: 'MINUTES' ) {
                ...
                recordIssues id: "jdk15", name: "Static Analysis jdk15", aggregatingResults: true, enabledForFailure: true, tools: [junitParser(), mavenConsole(), java(), checkStyle(), spotBugs(), pmdParser()]
              }
            }
          }
        }
